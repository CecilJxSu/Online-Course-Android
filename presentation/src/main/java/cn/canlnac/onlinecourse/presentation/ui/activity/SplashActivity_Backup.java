...
public class SplashActivity_Backup extends Activity {
    //视频视图
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //直接进入主页
        if (isNotFirst == 1) {
            Intent intent = new Intent(SplashActivity_Backup.this, MainActivity.class);
            ...
            if (i == mImageResIds.length - 1) {
                view.findViewById(R.id.iv_intro_text).setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        //偏好设置，保存记录
                        fileManager.writeToPreferences(SplashActivity_Backup.this,"Splash","isNotFirst",1);

                        Intent intent = new Intent(SplashActivity_Backup.this, MainActivity.class);
                        SplashActivity_Backup.this.startActivity(intent);
                        SplashActivity_Backup.this.finish();
                    }
                });
            }
            //添加到列表中
