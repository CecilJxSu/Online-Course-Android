...
@PerActivity
@Component(dependencies = ApplicationComponent.class, modules = {ActivityModule.class, UnlikeCourseModule.class})
public interface UnlikeCourseComponent extends ActivityComponent {
